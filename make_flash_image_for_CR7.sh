...
echo make_flash_image_for_CR7.sh - ImageCreate V1.0.5 Aug.31,2017

export IPL_TYPE=CR7
export MAKE_IMAGE_PATH=$PWD

#export SETTING_BOOTPARAM_PATH=setting/$IPL_TYPE/bootparam/v1
export SETTING_BOOTPARAM_PATH=setting/$IPL_TYPE/bootparam/v2
#export SETTING_CERT_HEADER_PATH=setting/$IPL_TYPE/cert_header/flash/v1
export SETTING_CERT_HEADER_PATH=setting/$IPL_TYPE/cert_header/flash/v2
...
$MAKE_IMAGE_PATH/bin/bin_create $MAKE_IMAGE_PATH/$SETTING_CERT_HEADER_PATH/cert_header_image_SA3.txt $MAKE_IMAGE_PATH/temp/cert_header_sa3.bin
...
objcopy -I binary -O srec --adjust-vma=0xE6320000 --srec-forceS3 $MAKE_IMAGE_PATH/temp/cert_header_sa3.bin $MAKE_IMAGE_PATH/output/cert_header_sa3.srec
